...
- `main` is always releasable; protected; merges only via PR with green CI (`verify.sh` matrix + repo-wide checks) and one review (human for `[INTEGRATION]`, security-touching, or API/schema PRs).
