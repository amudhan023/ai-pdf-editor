...
| `DocumentSession` | Document lifecycle, atomic save, viewer + sidebar + annotation UI; undo/redo pending | Perform PDF byte manipulation itself | **Partial** — open/save/tiled-viewer/sidebar/search/markup+comment-sidebar real (P0-07, P1-16, P1-01, P1-02, P1-03, P1-04, P1-05); undo/dirty/recovery for non-annotation edits pending — see [sessions/document-session.md](../sessions/document-session.md) |
...
| `DocEngineHost` | XPC client + PDFium adapter implementing `PDFEngineAPI` | Touch network/vault/unhanded files | **Partial** — lifecycle/tiled-render/outline/text-runs/annotations (incl. ink/freeText/stamp/link, P1-05)/save real against vendored PDFium (P0-06, P1-02, P1-03, P1-04, P1-05, P1-21); page-ops/forms pending — see [engines/doc-engine-host.md](../engines/doc-engine-host.md) |
