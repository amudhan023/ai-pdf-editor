...
`Packages/AutofillEngine/Sources/AutofillEngine/AutofillEngine.swift` is a 4-line placeholder. No field discovery, matcher, formatter, or planner exists yet.
