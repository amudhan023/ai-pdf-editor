...
**Raised by:** P1-04 · **Severity:** Medium — scopes down P1-04's acceptance criteria, does not block engine/session-layer work · **Status:** open, proceeding on interim scope
